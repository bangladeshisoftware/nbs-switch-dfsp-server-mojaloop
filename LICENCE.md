...
The Mojaloop DFSP Server files are made available by Bangladeshi Software Ltd.
...
This project implements a **Mojaloop DFSP (Digital Financial Service Provider)
Server** — the backend service that connects a financial institution to the
Mojaloop Switch. It handles payment initiation, party lookup, quote processing,
and transfer execution following the Mojaloop FSPIOP API standards.

**Key Components:**
- FSPIOP API Integration
- Party Lookup (ALS) Handler
- Quote Request and Response Handler
- Transfer Prepare and Fulfil Handler
- Callback Endpoint Management
- TLS/JWS Security Layer
